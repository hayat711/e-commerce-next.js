...
import {useCartItems} from "@/components/shoppingCart/hooks/useCartItems";
import {Stripe} from "stripe";
import {Cart} from '../components/shoppingCart/api/getCart';
...
export default async function ShoppingCart(props: Props) {
  const { data : CartItems  , isLoading, isFetching, isError} = useCartItems();
  // const { CartItems, totalPrice} = data;
  const {getCartItems, addItem, removeItem, updateItemQuantity } = Cart;
  const dataFromDb =await getCartItems();
  ...
  const handleCheckout = () => mutate(CartItems);
            ...
            <div className="flex shadow-md my-10">
              ...
              <div id="summary" className="w-1/4 px-8 py-10">
                ...
                <div className="flex justify-between mt-10 mb-5">
                  ...
                  <span className="font-semibold text-sm">{'not calculated yet'}$</span>
                </div>
                <div>
